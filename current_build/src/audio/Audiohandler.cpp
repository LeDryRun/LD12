...
void Audiohandler::load(){
	...
	background_music.openFromFile("../assets/sound/Ethans_song.wav");
	add_buffer("../assets/Pac-Man/audio/pac_new.wav","pac_man");
	add_buffer("../assets/Pac-Man/audio/pellet.wav","pellet");
	add_buffer("../assets/Pac-Man/audio/cherry.wav","cherry");
	add_buffer("../assets/Pac-Man/audio/pac_man_dies_quietly.wav","pac_man_dies");
